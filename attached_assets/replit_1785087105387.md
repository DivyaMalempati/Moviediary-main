...
_Populate as real preferences come up in conversation — e.g. naming conventions, code style choices, or product priorities the user has stated explicitly._
